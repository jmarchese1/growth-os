...
export default function EmbedoLogo({ size = 30 }: EmbedoLogoProps) {
  return (
    ...
    >
      {/* Orbiting particle wrappers — each rotates 360° around center */}
      {PARTICLES.map((p, i) => (
        <div
          key={i}
      ...
      >
        <defs>
          <linearGradient id="tg" x1="4" y1="4" x2="28" y2="16" gradientUnits="userSpaceOnUse">
        ...
        <polygon points="16,4 28,10 16,16 4,10" fill="url(#tg)" />
