    ...
    <section id="proposal" className="pt-20 pb-20 px-6 text-gray-900 relative overflow-hidden bg-white">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          {/* Left: floating animated proposal document */}
        ...
        {step === 'idle' && (
          <button
            ...
            className="px-8 py-4 bg-black text-white text-base font-semibold rounded-full transition-all hover:bg-indigo-700 hover:scale-105 active:scale-95"
          >
