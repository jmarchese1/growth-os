  ...
  if (toolEnabled === false) return (
    <div className="p-8 animate-fade-up">
      ...
      <div className="bg-white dark:bg-white/[0.04] border border-slate-200 dark:border-white/[0.08] rounded-xl p-12 text-center">
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">Enable Catering Requests from the Capabilities tab in your Chat Widget or Phone Agent settings.</p>
