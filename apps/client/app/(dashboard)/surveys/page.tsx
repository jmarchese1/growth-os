...
export default function SurveysPage() {
  return (
    <div className="p-8 animate-fade-up">
      ...
      <div>
        <h2 className="text-sm font-semibold text-slate-700 mb-4">Your Surveys</h2>
        <div className="bg-white border border-slate-200 rounded-xl p-8 text-center">
          <p className="text-slate-400 text-sm">No surveys created yet. Surveys will be automatically triggered after calls and appointments.</p>
        </div>
      </div>
    </div>
  );
