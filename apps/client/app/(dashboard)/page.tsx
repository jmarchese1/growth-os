    ...
    <div className="p-8 animate-fade-up">
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <ModuleStatus name="Chatbot" active={false} description="AI chat on website, IG & FB"
            icon={<svg viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5"><path fillRule="evenodd" d="M18 10c0 3.866-3.582 7-8 7a8.841 8.841 0 01-4.083-.98L2 17l1.338-3.123C2.493 12.767 2 11.434 2 10c0-3.866 3.582-7 8-7s8 3.134 8 7z" clipRule="evenodd" /></svg>} />
          <ModuleStatus name="Lead Engine" active={false} description="Lead capture, scoring & sequences"
            icon={<svg viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5"><path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v1h8v-1z" /></svg>} />
          ...
          <ModuleStatus name="Social Media" active={false} description="Content generation & scheduling"
          ...
          <ModuleStatus name="Website" active={false} description="Auto-generated business website"
          ...
          <ModuleStatus name="Outbound Prospecting" active={false} description="Cold email campaigns & enrichment"
