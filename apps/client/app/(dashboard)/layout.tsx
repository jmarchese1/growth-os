...
function Sidebar({
  ...
  return (
    ...
    >
      ...
      <div className={`relative border-b border-white/[0.06] flex items-center ${collapsed ? 'justify-center py-5 px-2' : 'px-5 py-5 gap-3'}`}>
        ...
        {!collapsed && (
          <div>
            ...
            <p className="text-[10px] text-violet-400/60 mt-0.5 leading-none font-medium uppercase tracking-widest">Client</p>
          </div>
        )}
      </div>
      ...
      {/* Drag handle */}
      <div className="absolute top-0 right-0 w-1.5 h-full cursor-col-resize hover:bg-violet-500/25 active:bg-violet-500/40 transition-colors z-40"
