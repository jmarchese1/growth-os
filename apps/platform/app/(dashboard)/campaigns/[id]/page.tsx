    ...
    <div className="relative p-8 animate-fade-up min-h-screen">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          {(() => {
            const conf = campaign?.apolloConfig as { totalEntries?: number; prospectsFetched?: number; remaining?: number; runsRemaining?: number } | null;
        ...
        {campaign && (
          <div className="flex items-center gap-2">
            ...
            <EditEmailButton
              ...
              prospectorUrl={PROSPECTOR_URL}
              apolloConfig={campaign.apolloConfig as Record<string, unknown> | null}
            />
            <CloneCampaignButton
              campaignId={id}
