  ...
  return (
    <div className="flex items-center gap-3">
      <button
        onClick={handleSync}
        disabled={syncing}
        className="flex items-center gap-2 px-4 py-2 rounded-xl bg-signal-soft border border-rule text-sm font-medium text-signal hover:bg-signal-soft hover:border-signal transition-colors disabled:opacity-50"
      >
